(() => {
  ...
  const SYSTEM_SOURCE = "./iaas-system.js?v=2026-06-03-offlineaccess01";
  ...
  window.__epividaCedulasReady = (async () => {
    ...
    try {
      ...
      console.error("No se pudo aplicar el cargador de cedulas preventivas; se usa el sistema base.", error);
