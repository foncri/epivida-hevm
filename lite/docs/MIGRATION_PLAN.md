...
- Ampliar `expedienteService` con cursores visibles por seccion; ya lee paciente por ID activo/archivo y primera pagina de `devices_archive`, IAAS, cultivos, antimicrobianos y auditoria por paciente.
