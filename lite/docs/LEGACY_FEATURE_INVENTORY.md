...
| Criterios IAAS y cedulas | `iaas-system-cedulas-loader-2026-05-21.js`, `iaas-system-followup-loader-2026-05-20.js` | Cargaba cedulas/formularios de seguimiento. | Si, reglas clinicas. | Loader y runtime no modulares. | `iaasCriteriaService.js`, `iaasService.js`, `modules/epi-iaas` | migrado parcial |
...
| Otros estudios | `iaas-system-runtime-2026-06-04.js:430` | Campos para estudios adicionales. | Si. | Sin modelo separado. | `iaasService.js`, `expediente` | migrado |
