...
| Antibioticos/antimicrobianos | `iaas-system-runtime-2026-06-04.js:474` | Catalogo IAAS de antimicrobianos y seguimiento. | Si. | Catalogo dentro del monolito. | `antimicrobialService.js`, `antimicrobials`, `clinicalFollowUp`, `microbiologyDashboard` | migrado |
