...
| Criterios IAAS y cedulas | `iaas-system-cedulas-loader-2026-05-21.js` | Cargaba cedulas/formularios clinicos IAAS. | Si, reglas clinicas. | Loader y runtime no modulares. | `iaasCriteriaService.js`, `iaasService.js`, `modules/epi-iaas` | migrado parcial |
