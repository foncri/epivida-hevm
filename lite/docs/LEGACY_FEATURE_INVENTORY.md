...
| Catalogo de camas conocidas | `hospital-bed-service-normalizer-2026-06-02.js:158` | Mantenia camas por servicio para tablero y normalizacion. | Si. | Parches sobre funciones globales y DOM. | `catalogService.js`, `roundService.js`, `roundHelpers.js` | migrado parcial |
