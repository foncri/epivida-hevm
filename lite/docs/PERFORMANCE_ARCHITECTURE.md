...
- El mapa de camas vive fuera del orquestador en `modules/ronda-paquetes/bedBoard.js`, los formularios preventivos en `preventiveForms.js` y el guardado/drafts en `saveRoundFlow.js`; el siguiente corte debe separar paciente individual e historial preventivo.
