...
- El mapa de camas vive fuera del orquestador en `modules/ronda-paquetes/bedBoard.js` y el guardado/drafts en `saveRoundFlow.js`; el siguiente corte debe separar formularios y paciente individual.
