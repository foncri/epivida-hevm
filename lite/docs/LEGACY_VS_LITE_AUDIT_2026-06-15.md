...
| Cloudflare | `https://epivida-hevm.pages.dev/epivida-lite-build.json` debe responder `release: 2026-06-16-parity03`, `Cache-Control: no-cache`, despues de publicar este bloque. |
...
| IAAS | Seguimiento completo en runtime: vitales, ventilacion, BH, EGO, estudios, cultivos, tratamientos. | `iaasService`, `iaasCriteriaService`, `modules/epi-iaas`, expediente y servicios de cultivos/antimicrobianos; incluye FiO2/PEEP. | Migrado base ampliado; seguimiento avanzado por secciones aun requiere validacion clinica formal. |
...
| Cloudflare build marker | Esperado tras publicacion: `2026-06-16-parity03`, `no-cache`. |
