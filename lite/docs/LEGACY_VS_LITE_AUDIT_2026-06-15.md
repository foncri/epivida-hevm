...
| Cloudflare | `https://epivida-hevm.pages.dev/epivida-lite-build.json` debe responder `release: 2026-06-16-parity07`, `Cache-Control: no-cache`, despues de publicar este bloque. |
...
| Cloudflare build marker | Esperado tras publicacion: `2026-06-16-parity07`, `no-cache`. |
